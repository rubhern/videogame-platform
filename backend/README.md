...
| `JdbcReleaseBrowseReadAdapterIntegrationTest` | PostgreSQL 18 read-adapter integration test | Database filters/count/page, complete ordering, TBA placement, product taxonomies, and safe published cover inputs |
