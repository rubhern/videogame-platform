...
| Application (`full` profile only) | `videogame-platform/application:0.7.3-SNAPSHOT` | `http://localhost:8080` | Packaged React frontend, same-origin BFF/API and Spring Boot modular monolith |
