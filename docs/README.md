...
| Proven operational procedures and evidence boundary for local and private `dev` | [Operations runbook](development/operations-runbook.md) | Links to the executable owner of each command; never policy or a second copy of a script |
| Frontend visual language and mandatory screen/component design rules | [Frontend design guidelines](development/frontend-design.md) | Links and local implementation context, never duplicated visual rules |
