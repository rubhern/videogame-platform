...
| Q-005 | Which game-data provider and licence can support the MVP? | Data rights and provider constraints can invalidate the journey | The [documentary comparison](../research/game-data-providers-spike.md) selects IGDB for the first authenticated PoC and RAWG as fallback. The owner approved the [acceptance thresholds and 60-case sample](../research/game-data-providers-spike.md#104-métricas-de-aceptación-confirmadas) for execution on 2026-07-24. Run the authenticated PoC and record the applicable non-commercial terms; before public or monetized use, clarify partnership, attribution, retained data, and image rights. Evaluate RAWG only if IGDB fails and RAWG clarifies its contradictory terms | Ruben Hernandez | Technical decision before catalogue implementation; contractual decision before public release | In validation — authenticated IGDB PoC approved for execution |
